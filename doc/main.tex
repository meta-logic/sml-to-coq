...
\\
\infern{\smle{e_1}\stog\coqe{t_1} & \dots & \smle{e_n}\stog\coqe{t_n}}{\smle{(e_1, ... , e_n)}\stog\coqe{(t_1, ... ,t_n)}}{AtExp}
\\
\infern{\smle{e_1}\stog\coqe{t_1} & \dots & \smle{e_n}\stog\coqe{t_n}}{\smle{[e_1, ... , e_n]}\stog\coqe{[t_1; ... ;t_n]}}{AtExp}
\end{array}
\]
\laila{op VId, Records, and Units have not yet been translated}
\giselle{Definitions in let expressions are translated as external definitions?}
