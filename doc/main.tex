...
\begin{itemize}
  ...
  \item We use \coqe{%float} for translating real numbers because numbers like
...
TODO: In this section we mention which names need modification.

\begin{itemize}
  \item $\mathsf{Lab}$ are valid record labels.
...
&
\infer[\mathsf{TyExp}_{\smles{TyRow}}]{\smle{\{ t \}} \stogty \coqe{\{ t' \}}}{
  \smle{t} \stogtyrow \coqe{t'}
}
\\
