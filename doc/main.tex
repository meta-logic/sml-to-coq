...
&
\infer[\mathsf{SCon}_{\smles{int}_{-}}]{\smle{\~ n} \stogscon \coqe{- n}}{}
\\
\infer[\mathsf{SCon}_{\smles{real}}]{\smle{r} \stogscon \coqe{r\%float}}{}
&
\infer[\mathsf{SCon}_{\smles{real}_{-}}]{\smle{\~ r} \stogscon \coqe{(- r)\%float}}{}
\\
...
\\
\infer[\mathsf{AtExp}_{\smles{op}}]{\smle{op VId} \stogatexp \tbd}{}
\\
