...
\infer[\mathsf{TyBind}_0]{\smle!$'v_1, \dots, 'v_n$ con = t! \stogtybind \coqe!con' $v'_1 \dots v'_n$ = t'!}{
  ...
  \smle{t} \stogty \coqe{t'}
  &
  'v_i \stogty v'_i \;\; \forall i. 1 \leq i \leq n, n \geq 0
}
\\
...
\end{array}
\]
\giselle{Fix primes type vars in the conclusion of first rule.}
...
\end{array}
\]
\giselle{add translations for op VId and Records.}
