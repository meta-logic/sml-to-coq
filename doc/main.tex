...
In the example above, the induction principle that is generated by the translation would be: \\ 

\begin{coq}
    Theorem tree_ind_princip: forall  (_a : Type) (P:@tree _a -> Prop), P Empty -> (forall p1, P (Leaf (p1))) -> (forall p1 p2 p3, P p1 -> P p3 -> P (Node (p1, p2, p3))) -> forall tree_obj, P tree_obj.
\end{coq}
\\ \vspace{10pt}
