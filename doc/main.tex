...
\begin{array}{cc}
\infer[\mathsf{TyCon}_{\smles{unit}}]{\smle{unit} \stog \coqe{unit}}{}
&
...
\\
\infern{\smle{e} \stog \coqe{t}\quad \smle{d}\stog \coqe{Definition d'}}{
  \smle{let d in e end} \stog \coqe{let d' in t}
}{AtExp}
\\
\infern{
  \begin{gathered}
  \smle{e} \stog \coqe{t}\quad \smle{d}\stog \coqe{sentence}_1 ... \coqe{sentence}_n \\ 
  \coqe{sentence}_1 \equiv \coqe{Definition d}_1 \quad ... \quad \coqe{sentence}_n \equiv \coqe{Definition d}_n 
  \end{gathered}
}{
  \smle{let d in e end} \stog \coqe!let d$_1$ in ... in let d$_n$ in t!
}{\mathsf{AtExp}}
\\
\infern{\smle{e} \stog \coqe{t}}{\smle{(e)}\stog\coqe{(t)}}{AtExp}
\\
\infern{\smle{e_1}\stog\coqe{t_1} & \dots & \smle{e_n}\stog\coqe{t_n}}{
  \smle{(e_1, ... , e_n)}\stog\coqe{(t_1, ... ,t_n)}
}{AtExp}
\\
\infern{\smle{e_1}\stog\coqe{t_1} & \dots & \smle{e_n}\stog\coqe{t_n}}{
  \smle{[e_1, ... , e_n]}\stog\coqe{[t_1; ... ;t_n]}
...
TODO: This is currently encompassed in the section above, but I am not happy
with the notation.
