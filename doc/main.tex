...
\begin{grm}
SpecialConst ::= /* integer, real, word, strings, 
                    and character constants */

Id ::= /* allowed identifiers */

/* Atomic Expressions */
AtExp ::= SpecialConst | op Id | Id | {Lab: Exp, Lab: Exp, ...} 
        | let Dec in Exp end | (Exp) 
        /* Added expressions (translated to records originally) */
        | () |  (Exp, Exp, ...) | [Exp, Exp, ...]

/* Expressions */
Exp ::= AtExp | Exp AtExp | Exp : Ty | Exp handle Match
      | raise Exp | fn Match
      /* Added expressions (derived forms) */
      | case Exp of Match | if Exp then Exp else Exp
      | Exp andalso Exp | Exp orelse Exp
