...
that they are not confused with \coqe{nat} multiplication. For
example, the following definition fails without annotating the tuple
type:
...
\laila{Because "*" is overloaded (multiplication)}
